...
function PANEL:Init()
	...
	self.LeftContentPanel:AddSheet("实体道具", vgui.Create("Flood_ShopMenu_Props", self.LeftFrame), "icon16/house.png")
	self.LeftContentPanel:AddSheet("武器商城", vgui.Create("Flood_ShopMenu_Weapons", self.LeftFrame), "icon16/gun.png")
	...
	self.RightContentPanel:AddSheet("工具", vgui.Create("Flood_ShopMenu_Tools", self.RightFrame), "icon16/wrench.png")
	local PropProtection = vgui.Create("Flood_ShopMenu_PropProtection", self.RightFrame)
	self.RightContentPanel:AddSheet("道具保护", PropProtection, "icon16/asterisk_orange.png")
